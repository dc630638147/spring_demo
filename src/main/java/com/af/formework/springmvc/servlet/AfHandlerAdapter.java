 ...
 */
public class AfHandlerAdapter {
    public boolean supports(Object handler){ return (handler instanceof AfHandlerMapping);}


    AfModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        AfHandlerMapping handlerMapping = (AfHandlerMapping)handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == AfModelAndView.class;
        if(isModelAndView){
            return (AfModelAndView) result;
        }
        return null;
    }
